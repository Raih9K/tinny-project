...
const TRANSLATIONS = {
  ...
  "es-ES": {
    ...
    startConversationHelp:
      "¡Inicia una conversación y te ayudaré a aprender con comentarios personalizados!",
    ...
    sorryTroubleResponding:
      "Lo siento, tengo problemas para responder ahora. ¡Sigamos practicando!",
    spanishContinue: "¡Sigamos practicando!",
    frenchContinue: "Continuons à pratiquer!",
...
const LanguageTutor = () => {
  ...
  const generateLearningGoals = (level, language) => {
    ...
    const goals =
      goalsByLevel[level]?.[language] || goalsByLevel.Beginner.spanish;
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          {messages.length === 0 && (
            <div className="text-center py-8">
              ...
              <p className="text-gray-500">{t("startConversationHelp")}</p>
            </div>
          )}
