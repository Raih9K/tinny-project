import { ArrowRight, ChevronDown, Code, Loader2 } from "lucide-react";
...
const TRANSLATIONS = {
  "en-US": {
    ...
    footerText1:
      "CodeVerter uses Claude AI to convert code between programming languages.",
  ...
  "es-ES": {
    ...
    footerText1:
      "CodeVerter utiliza Claude AI para convertir código entre lenguajes de programación.",
    ...
    errorConversionFailed:
      "Error al convertir el código. Por favor intenta de nuevo.",
